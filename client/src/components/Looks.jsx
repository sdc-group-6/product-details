...
class Looks extends Component {
  ...
  //       <div className="column">
  //         <div className="looks-pics">
  //           <div className={cardShirt} id="shirtCard" onClick={this.selectShirt} data-toggle="collapse" data-target="#shirtView" role="button" aria-expanded="false" aria-controls="shirtView"><h6><img src={this.props.looks.shirt_url}></img><br></br><br></br>${this.props.looks.shirt_price}</h6></div>
  //           <div className={cardJacket} id="jacketCard" onClick={this.selectJacket} data-toggle="collapse" data-target="#jacketView" role="button" aria-expanded="false" aria-controls="jacketView"><h6><img src={this.props.looks.jacket_url}></img><br></br><br></br>${this.props.looks.jacket_price}</h6></div>
  //           <div className={cardPant} id="pantCard"onClick={this.selectPant} data-toggle="collapse" data-target="#pantView" role="button" aria-expanded="false" aria-controls="pantView"><h6><img src={this.props.looks.pant_url}></img><br></br><br></br>${this.props.looks.pant_price}</h6></div>
  //         </div>
  //       <div className="collapse" id="shirtView" data-parent=".looks" aria-labelledby="shirtCard">
  //         <div className="container">
  //           <div className="row">
  //             <div className="col-sm look-img">
  //               <img src={this.props.looks.shirt_url} height="180" width="180"></img>
  //             </div>
  //             <div className ="col-sm look-desc">
  //               <h5 className="look-clothing-name">{this.props.looks.shirt_name}</h5>
  //               <h6 className="look-clothing-price">${this.props.looks.shirt_price}</h6>
  ...
  //           <div className="row">
  //             <div className="col-sm look-img">
  //               <img src={this.props.looks.jacket_url} height="180" width="180"></img>
  //             </div>
  //             <div className ="col-sm look-desc">
  //               <h5 className="look-clothing-name">{this.props.looks.jacket_name}</h5>
  //               <h6 className="look-clothing-price">${this.props.looks.jacket_price}</h6>
  ...
  //           <div className="row">
  //             <div className="col-sm look-img">
  //               <img src={this.props.looks.pant_url} height="180" width="180"></img>
  //             </div>
  //             <div className ="col-sm look-desc">
  //               <h5 className="look-clothing-name">{this.props.looks.pant_name}</h5>
  //               <h6 className="look-clothing-price">${this.props.looks.pant_price}</h6>
